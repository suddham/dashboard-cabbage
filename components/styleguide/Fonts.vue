<template>
  <div class="flex flex-wrap items-stretch justify-start">
    <header
      class="w-full lg:w-auto border-gray-400 pb-6 lg:pb-0 lg:border-b-0 lg:pr-12 lg:border-r"
    >
      <h1>Heading h1</h1>
      <h2>Heading h2</h2>
      <h3>Heading h3</h3>
    ...
    >
      ...
      <p class="pt-4 font-bold">Font bold lorem ipsum</p>
    </div>
    <p
    ...
    >
      ...
      <span class="text-lg">Fira Sans</span>
    </p>
  </div>
</template>
